...
/**
 * Test for /model/{modelId}
 */
Test('/model/{modelId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getModelById get operation', function (t) {
            Mockgen().requests({
                path: '/model/{modelId}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/model/{modelId}']['get']['responses']['200']['schema']);
         ...
         * responses: 405
         */
        t.test('test updateModelWithForm post operation', function (t) {
            Mockgen().requests({
                path: '/model/{modelId}',
                operation: 'post'
            }, function (err, mock) {
         ...
         * responses: 400, 404
         */
        t.test('test deleteModel delete operation', function (t) {
            Mockgen().requests({
                path: '/model/{modelId}',
                operation: 'delete'
            }, function (err, mock) {
