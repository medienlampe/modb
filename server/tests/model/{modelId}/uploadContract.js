...
/**
 * Test for /model/{modelId}/uploadContract
 */
Test('/model/{modelId}/uploadContract', function (t) {
        ...
        t.test('test uploadFile post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/model/{modelId}/uploadContract']['post']['responses']['200']['schema']);
