...
/**
 * Test for /models/findByTags
 */
Test('/models/findByTags', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test findModelsByTags get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/models/findByTags']['get']['responses']['200']['schema']);
